...
This file collects friction reports from beta-cohort adopters and consumer-tool builders. It's the input stream that shapes the v0.2 spec.
...
The maintainer reviews `feedback.md` entries before any v0.2 spec proposal. Themes that show up in multiple reports become candidate spec changes; single-report ideas land in the issue tracker for discussion.
